...
- 库版本：v2.1.1 ｜ 源库 sha256：`92dec6a75e9fc8adce7ebcd8eb50c29c1dc235544c608ef63a34e94258cdec7c`
...
| `review/L1_group.md` | 群体 | 实体 23 个 | 22718 字符 |
...
| `review/L1_facts_1.md` | facts 断言全集 第1册 | 1866 条 facts | 27217 字符 |
| `review/L1_facts_2.md` | facts 断言全集 第2册 | 1866 条 facts | 27996 字符 |
| `review/L1_facts_3.md` | facts 断言全集 第3册 | 1866 条 facts | 29749 字符 |
| `review/L1_facts_4.md` | facts 断言全集 第4册 | 1866 条 facts | 29900 字符 |
| `review/L1_facts_5.md` | facts 断言全集 第5册 | 1866 条 facts | 29829 字符 |
...
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 355175 字符 |
