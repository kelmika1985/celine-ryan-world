...
| `review/L1_location_1.md` | 地点（第 1 册，共 3 册） | 实体 43 个 | 29679 字符 |
...
| `review/L1_era_afterstory_3.md` | 后日谈时代（第 3 册，共 4 册） | 时代分页 110 个 | 28453 字符 |
...
| `review/L1_facts_6.md` | facts 断言全集 第6册 | 1936 条 facts | 29976 字符 |
...
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 373263 字符 |
