...
- 库版本：v2.1.1 ｜ 源库 sha256：`0675de3043a4133df0e2e8e786d318d7a7b035b1c5a8896f4264069df8303d1e`
...
| `review/L1_location_1.md` | 地点（第 1 册，共 3 册） | 实体 43 个 | 29673 字符 |
| `review/L1_location_2.md` | 地点（第 2 册，共 3 册） | 实体 43 个 | 29510 字符 |
| `review/L1_location_3.md` | 地点（第 3 册，共 3 册） | 实体 43 个 | 13589 字符 |
| `review/L1_world_rule.md` | 世界规则 | 实体 26 个 | 22056 字符 |
| `review/L1_group.md` | 群体 | 实体 23 个 | 25098 字符 |
...
| `review/L1_era_afterstory_3.md` | 后日谈时代（第 3 册，共 4 册） | 时代分页 110 个 | 28447 字符 |
| `review/L1_era_afterstory_4.md` | 后日谈时代（第 4 册，共 4 册） | 时代分页 110 个 | 18755 字符 |
| `review/L1_facts_1.md` | facts 断言全集 第1册 | 1936 条 facts | 27235 字符 |
| `review/L1_facts_2.md` | facts 断言全集 第2册 | 1936 条 facts | 28131 字符 |
| `review/L1_facts_3.md` | facts 断言全集 第3册 | 1936 条 facts | 29794 字符 |
| `review/L1_facts_4.md` | facts 断言全集 第4册 | 1936 条 facts | 29986 字符 |
| `review/L1_facts_5.md` | facts 断言全集 第5册 | 1936 条 facts | 24214 字符 |
| `review/L1_facts_6.md` | facts 断言全集 第6册 | 1936 条 facts | 29956 字符 |
| `review/L1_facts_7.md` | facts 断言全集 第7册 | 1936 条 facts | 19815 字符 |
| `review/L1_relations.md` | 关系表 | 240 条关系 | 32725 字符 |
| `review/L1_timeline.md` | 时间线 | 86 个时间点 | 7682 字符 |
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 373257 字符 |
