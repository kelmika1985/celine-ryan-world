...
- 库版本：v2.1.1 ｜ 源库 sha256：`9d18ae02407b099a9ef51eef6528450cb77971e99e000f0f9e4018427e41d80f`
...
| `review/L1_location_1.md` | 地点（第 1 册，共 3 册） | 实体 43 个 | 29535 字符 |
| `review/L1_location_2.md` | 地点（第 2 册，共 3 册） | 实体 43 个 | 29438 字符 |
| `review/L1_location_3.md` | 地点（第 3 册，共 3 册） | 实体 43 个 | 1471 字符 |
...
| `review/L1_era_mainline_4.md` | 主线时代（第 4 册，共 4 册） | 时代分页 87 个 | 14100 字符 |
...
| `review/L1_era_afterstory_3.md` | 后日谈时代（第 3 册，共 4 册） | 时代分页 110 个 | 29439 字符 |
| `review/L1_era_afterstory_4.md` | 后日谈时代（第 4 册，共 4 册） | 时代分页 110 个 | 2614 字符 |
| `review/L1_facts_1.md` | facts 断言全集 第1册 | 1880 条 facts | 27235 字符 |
| `review/L1_facts_2.md` | facts 断言全集 第2册 | 1880 条 facts | 28131 字符 |
| `review/L1_facts_3.md` | facts 断言全集 第3册 | 1880 条 facts | 29794 字符 |
| `review/L1_facts_4.md` | facts 断言全集 第4册 | 1880 条 facts | 29922 字符 |
| `review/L1_facts_5.md` | facts 断言全集 第5册 | 1880 条 facts | 29804 字符 |
| `review/L1_facts_6.md` | facts 断言全集 第6册 | 1880 条 facts | 29506 字符 |
| `review/L1_relations.md` | 关系表 | 240 条关系 | 32712 字符 |
| `review/L1_timeline.md` | 时间线 | 86 个时间点 | 7682 字符 |
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 358413 字符 |
