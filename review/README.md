...
- 库版本：v2.1.1 ｜ 源库 sha256：`c989e62dc3b89c19d07c6ee716b8e5d874c398372eeb79d93c1ff1d91c2e8668`
...
| `review/L1_character_5.md` | 人物（第 5 册，共 7 册） | 实体 75 个 | 29659 字符 |
...
| `review/L1_era_mainline_2.md` | 主线时代（第 2 册，共 4 册） | 时代分页 87 个 | 29879 字符 |
...
| `review/L1_facts_3.md` | facts 断言全集 第3册 | 1866 条 facts | 29770 字符 |
...
| `review/L1_relations.md` | 关系表 | 240 条关系 | 32478 字符 |
| `review/L1_timeline.md` | 时间线 | 86 个时间点 | 7682 字符 |
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 356133 字符 |
