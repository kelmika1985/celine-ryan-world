...
- 库版本：v2.1.1 ｜ 源库 sha256：`bca46ae664d6765a74bc8c9a22295838d496c218bd0ac8d45b647fd9d82033ba`
...
| `review/L1_location_1.md` | 地点（第 1 册，共 3 册） | 实体 43 个 | 28363 字符 |
| `review/L1_location_2.md` | 地点（第 2 册，共 3 册） | 实体 43 个 | 29672 字符 |
| `review/L1_location_3.md` | 地点（第 3 册，共 3 册） | 实体 43 个 | 18441 字符 |
| `review/L1_world_rule.md` | 世界规则 | 实体 26 个 | 22056 字符 |
| `review/L1_group.md` | 群体 | 实体 23 个 | 25228 字符 |
...
| `review/L1_era_afterstory_3.md` | 后日谈时代（第 3 册，共 4 册） | 时代分页 110 个 | 26192 字符 |
| `review/L1_era_afterstory_4.md` | 后日谈时代（第 4 册，共 4 册） | 时代分页 110 个 | 24683 字符 |
| `review/L1_facts_1.md` | facts 断言全集 第1册 | 1951 条 facts | 27235 字符 |
| `review/L1_facts_2.md` | facts 断言全集 第2册 | 1951 条 facts | 28131 字符 |
| `review/L1_facts_3.md` | facts 断言全集 第3册 | 1951 条 facts | 29794 字符 |
| `review/L1_facts_4.md` | facts 断言全集 第4册 | 1951 条 facts | 29986 字符 |
| `review/L1_facts_5.md` | facts 断言全集 第5册 | 1951 条 facts | 24268 字符 |
| `review/L1_facts_6.md` | facts 断言全集 第6册 | 1951 条 facts | 29662 字符 |
| `review/L1_facts_7.md` | facts 断言全集 第7册 | 1951 条 facts | 23712 字符 |
| `review/L1_relations.md` | 关系表 | 240 条关系 | 32725 字符 |
| `review/L1_timeline.md` | 时间线 | 86 个时间点 | 7682 字符 |
| `review/L2_全量基线.md` | 全量基线（L0+实体+关系+时间线） | 全库 | 377091 字符 |
